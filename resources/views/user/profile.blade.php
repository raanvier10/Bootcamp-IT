...
<div class="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
        ...
        <div class="md:col-span-7">
            <form method="POST" action="{{ route('user.profile.update') }}" enctype="multipart/form-data" class="bg-canvas rounded-[24px] shadow-card-sm border border-hairline p-6 sm:p-8" id="profile-form">
                @csrf
                @method('PUT')
        ...
        <div class="md:col-span-5">
            <form method="POST" action="{{ route('user.profile.password') }}" class="bg-canvas rounded-[24px] shadow-card-sm border border-hairline p-6 sm:p-8" id="password-form">
                @csrf
                @method('PUT')
