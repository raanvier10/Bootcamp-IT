...
<head>
    ...
    <title>419 - Sesi Kedaluwarsa | TrashReport</title>
    ...
    <main class="flex-1 flex items-center justify-center p-4 sm:p-6 my-6">
        <div class="max-w-lg w-full bg-white rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 p-6 sm:p-10 text-center relative overflow-hidden">
            ...
            <p class="text-gray-500 text-sm sm:text-base mb-6 leading-relaxed">
                Halaman telah kedaluwarsa karena tidak ada aktivitas beberapa saat atau baru saja terjadi perpindahan akun/sesi.
            </p>

            <!-- Action Buttons -->
            <div class="space-y-2.5">
                <button onclick="window.location.reload()" class="w-full inline-flex items-center justify-center gap-2 py-3 px-5 rounded-xl text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 transition shadow-sm shadow-emerald-200">
                    <i data-lucide="rotate-cw" class="w-4 h-4"></i>
                    Muat Ulang Halaman Sekarang
                </button>

                <a href="{{ route('login') }}" class="w-full inline-flex items-center justify-center gap-2 py-3 px-5 rounded-xl text-sm font-semibold text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 active:bg-gray-100 transition shadow-sm">
