...
<section class="py-16 lg:py-24">
    <div class="max-w-md mx-auto px-6">
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-semibold text-ink tracking-tight mb-2" style="letter-spacing:-0.8px">Lupa Password</h1>
            <p class="text-body">Masukkan email Anda untuk menerima tautan reset password.</p>
        </div>
